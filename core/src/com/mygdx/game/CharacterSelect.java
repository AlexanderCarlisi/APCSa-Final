                ...
                case 0: {
                    ...
                    attackConfigs = new Fighter.AttackConfig[] {
                            ...
                            new Fighter.AttackConfig(Attack.attackType.Special, Attack.direction.Side, 3, 0.4f,
                                    ...
                                    new Vector2(GDXHelper.PTM(25), GDXHelper.PTM(10)),
                                    true, false, 500f),
                            new Fighter.AttackConfig(Attack.attackType.Special, Attack.direction.Up, 3, 1f, 100,
                                    new Vector2(0, 0.4f),
                                    new Vector2(GDXHelper.PTM(30), GDXHelper.PTM(10)),
                                    new Vector2(0f, 0.1f),
                                    false, true, 500f),
                            new Fighter.AttackConfig(Attack.attackType.Special, Attack.direction.Down, 3, 1f,
                                    new Vector2(0.4f, -0.35f),
                                    new Vector2(GDXHelper.PTM(20), GDXHelper.PTM(15)),
                                    false, false, 500f),
